...
at(1500, { type: 'agent:return', agentId: 1, result: 'Web findings on Rust ownership across 3 fetched pages.' });
at(1550, { type: 'agent:return', agentId: 2, result: 'Corpus findings on Swift ARC from 4 file reads.' });
...
at(3000, { type: 'agent:return', agentId: 3, result: 'Axis 1 (accuracy): both correct, different costs.' });
at(3050, { type: 'agent:return', agentId: 4, result: 'Axis 2 (perf): Rust faster cold path.' });
at(3100, { type: 'agent:return', agentId: 5, result: 'Axis 3 (complexity): Swift simpler day-1.' });
